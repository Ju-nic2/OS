...
asmlinkage long sys_op_add(long operand1, long operand2, long * result);
asmlinkage long sys_op_sub(long operand1, long operand2, long * result);
asmlinkage long sys_op_mul(long operand1, long operand2, long * result);
asmlinkage long sys_op_mod(long operand1, long operand2, long * result);
#endif
